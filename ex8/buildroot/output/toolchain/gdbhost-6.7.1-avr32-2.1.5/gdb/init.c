...
extern initialize_file_ftype _initialize_avr32_tdep;
extern initialize_file_ftype _initialize_avr32_linux_tdep;
...
initialize_all_files (void)
{
  ...
  _initialize_avr32_tdep ();
  _initialize_avr32_linux_tdep ();
  _initialize_solib ();
