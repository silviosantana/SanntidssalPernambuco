...
enum attr_type {TYPE_ALU, TYPE_ALU2, TYPE_ALU_SAT, TYPE_MULHH, TYPE_MULWH, TYPE_MULWW_W, TYPE_MULWW_D, TYPE_DIV, TYPE_MACHH_W, TYPE_MACWW_W, TYPE_MACWW_D, TYPE_BRANCH, TYPE_CALL, TYPE_LOAD, TYPE_LOAD_RM, TYPE_STORE, TYPE_LOAD2, TYPE_LOAD4, TYPE_STORE2, TYPE_STORE4, TYPE_FMUL, TYPE_FCMPS, TYPE_FCMPD, TYPE_FCAST, TYPE_FMV, TYPE_FMVCPU, TYPE_FLDD, TYPE_FSTD, TYPE_FLDS, TYPE_FSTS, TYPE_FSTM};
extern enum attr_type get_attr_type (rtx);

#define HAVE_ATTR_cc
enum attr_cc {CC_NONE, CC_SET_VNCZ, CC_SET_NCZ, CC_SET_CZ, CC_SET_Z, CC_SET_Z_IF_NOT_V2, CC_BLD, CC_COMPARE, CC_CMP_COND_INSN, CC_CLOBBER, CC_CALL_SET, CC_FPCOMPARE, CC_FROM_FPCC};
extern enum attr_cc get_attr_cc (rtx);

#define HAVE_ATTR_pipeline
enum attr_pipeline {PIPELINE_AP, PIPELINE_UCR1, PIPELINE_UCR2, PIPELINE_UCR2NOMUL};
extern enum attr_pipeline get_attr_pipeline (void);
