...
#define gt_ggc_m_15minipool_labels(X) do { \
  if (X != NULL) gt_ggc_mx_minipool_labels (X);\
  } while (0)
extern void gt_ggc_mx_minipool_labels (void *);
...
#define gt_pch_n_15minipool_labels(X) do { \
  if (X != NULL) gt_pch_nx_minipool_labels (X);\
  } while (0)
extern void gt_pch_nx_minipool_labels (void *);
...
extern void gt_pch_p_16machine_function
    (void *, void *, gt_pointer_operator, void *);
extern void gt_pch_p_15minipool_labels
    (void *, void *, gt_pointer_operator, void *);
