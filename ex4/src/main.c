...
int main(){
	...
	//TASK A
// 	xTaskCreate(taskA_0, "", 1024, NULL, tskIDLE_PRIORITY + 1, NULL);
// 	xTaskCreate(taskA_1, "", 1024, NULL, tskIDLE_PRIORITY + 1, NULL);


	//TASK B and C
	
	xTaskCreate(responseTaskC, "C", 1024, (&(struct responseTaskArgs){{TEST_C, RESPONSE_C}}), tskIDLE_PRIORITY + 1, NULL);
	xTaskCreate(responseTask, "B", 1024, (&(struct responseTaskArgs){{TEST_B, RESPONSE_B}}), tskIDLE_PRIORITY + 1, NULL);
	xTaskCreate(responseTask, "A", 1024, (&(struct responseTaskArgs){{TEST_A, RESPONSE_A}}), tskIDLE_PRIORITY + 1, NULL);
